            ...
            <div class="card-body">
                <form action="{{ url('buku/' . $buku->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $buku->no_klasifikasi }}" class="form-control" id="no_klasifikasi"
                            name="no_klasifikasi">
                    </div>
                    <div class="mb-3">
                        <label for="judul_buku" class="form-label">Judul Buku</label>
                        <input type="text" value="{{ $buku->judul_buku }}" class="form-control" id="judul_buku"
                            name="judul_buku">
                    </div>
                    <div class="mb-3">
                        <label for="jenis" class="form-label">Jenis</label>
                        <select type="text" value="{{ $buku->jenis }}" class="form-select" id="jenis" name="jenis">
                    ...
                    <div class="mb-3">
                        ...
                        <select type="text" value="{{ $buku->mapel }}" class="form-select" id="mapel" name="mapel">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $buku->nama_pengarang }}" class="form-control" id="nama_pengarang"
                            name="nama_pengarang">
                    </div>
                    <div class="mb-3">
                        <label for="penerbit" class="form-label">Nama Penerbit</label>
                        <input type="text" value="{{ $buku->penerbit }}" class="form-control" id="penerbit"
                            name="penerbit">
                    </div>
                    <div class="mb-3">
                        <label for="tahun_terbit" class="form-label">Tahun Terbit</label>
                        <input type="number" value="{{ $buku->tahun_terbit }}" class="form-control" id="tahun_terbit"
                            name="tahun_terbit">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
                        <input type="number" value="{{ $buku->harga }}" class="form-control" id="harga" name="harga">
                    </div>
                    <div class="mb-3">
                        <label for="jumlah_buku" class="form-label">Jumlah Buku</label>
                        <input type="number" value="{{ $buku->jumlah_buku }}" class="form-control" id="jumlah_buku"
                            name="jumlah_buku">
                    </div>
                    <div class="mb-3">
                        <label for="staf_penerima" class="form-label">Staf Penerima</label>
                        <input type="text" value="{{ $buku->staf_penerima }}" class="form-control" id="staf_penerima"
                            name="staf_penerima">
                    </div>
                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <input type="text" value="{{ $buku->keterangan }}" class="form-control" id="keterangan"
                            name="keterangan">
                    </div>
                    <div class="text-right">
                        <a type="button" href="{{ url('buku') }}" class="btn btn-secondary">Kembali</a>
